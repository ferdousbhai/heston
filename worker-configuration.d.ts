/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 12396dfe2857c6bae77582afce50f853)
...
interface __BaseEnv_Env {
	...
	DanAgent: DurableObjectNamespace<import("./src/server").DanAgent>;
	DAILY_RESEARCH_WORKFLOW: Workflow<Parameters<import("./src/server").DailyResearchWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "MarketFeed" | "DanAgent" | "BrokerGate";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_BASE_URL" | "TASTYTRADE_API_BASE" | "TELEGRAM_LONG_VOL_CHAT_ID" | "TELEGRAM_BOT_TOKEN">> {}
}
