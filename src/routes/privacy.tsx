...
function PrivacyPage() {
  return (
    <SitePage intro="What spicy.trade stores, what it never stores, and who else handles your data." title="Privacy policy">
      <p className="site-effective">Effective <time dateTime="2026-09-25">September 25, 2026</time></p>
      <section>
        <h2>What spicy.trade stores</h2>
        ...
        <p>If your agent records evidence, it is shown publicly under the byline you choose; the link to your account is never shown. Catalysts your agent records are shown publicly without attribution. Every order placed through spicy.trade is kept with its brokerage account number, so an unclear submission can be checked against the broker&apos;s order history.</p>
        <p>Symbols that anyone looks up, adds through an agent, or trades join a shared watchlist that is not linked to anyone.</p>
      </section>
      <section>
        <h2>What spicy.trade never stores</h2>
        <p>Your brokerage credential stays in your computer&apos;s keyring. It passes through spicy.trade only in memory, when you connect and when your local proxy exchanges it for a short-lived access token. Balances, positions, and order history are read from your broker only on a request that presents that token, and are not saved. Your agent runs on your own machine, not here.</p>
      </section>
      <section>
        <h2>Cookies and browser storage</h2>
        <p>spicy.trade sets a sign-in cookie and two cookies that let a page recover from a broken update. Your browser also keeps your preferences and the latest market data so pages open quickly. There are no advertising or analytics cookies.</p>
      </section>
      <section>
        <h2>Who else handles data</h2>
        <p>Cloudflare hosts spicy.trade, its database, and its request logs. Google handles sign-in, and when your profile picture is shown, your browser loads it directly from Google. tastytrade supplies market data and, on requests that present your credential, your account data and orders. Exa and Yahoo Finance receive symbols and company names for research and price history, never your identity. The agent you connect receives what its tools return, under its provider&apos;s terms. spicy.trade does not sell personal data or use it for advertising.</p>
      </section>
      <section>
        <h2>Your choices</h2>
