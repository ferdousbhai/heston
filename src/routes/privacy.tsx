  ...
  return (
    <SitePage intro="What Spice processes, why it is needed, and the choices available to you." title="Privacy policy">
      ...
      <section>
        ...
        <p>Records are kept only as long as reasonably needed for the service, security, legal obligations, and dispute resolution. Spice uses access controls and encrypted transport, but no system can guarantee absolute security. Do not include secrets or unnecessary personal information in prompts or support emails.</p>
      </section>
      <section>
        <h2>Your choices</h2>
