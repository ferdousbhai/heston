  ...
  return (
    <SitePage intro="The rules for using Spice and its connected market and brokerage tools." title="Terms of use">
      ...
      <section>
        ...
        <p>Spice can display information from third parties and prepare instructions for a connected brokerage account. Those providers control their own services, data, executions, fees, and terms. A draft, preview, or confirmation in Spice is not a guarantee that an order was accepted, filled, cancelled, or priced as shown. Verify material activity with the broker.</p>
      </section>
      <section>
