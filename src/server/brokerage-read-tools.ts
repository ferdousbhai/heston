...
function compactMetric(row: JsonRecord): CompactMarketMetric {
  ...
  return {
    ...
    historicalVolatility30Day: optionalRatioPercent(row, ['historical-volatility-30-day'], label),
    impliedHistoricalVolatility30DayDifference: optionalRatioPercent(row, ['iv-hv-30-day-difference'], label),
