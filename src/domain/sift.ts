 ...
 *
 * The product does this in several places — a catalyst whose citation does not hold, an idea
 ...
 * with little to verify. Naming the shape once keeps those from drifting into different ideas
