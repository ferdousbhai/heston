...
export const marketTickersFixture: Ticker[] = [
  { symbol: 'SPY', name: 'SPDR S&P 500 ETF', price: 691.24, change: 3.82, changePercent: 0.56, sparkline: spark(685, [0, 1.2, 0.4, 2.5, 1.7, 3.8, 4.5, 3.9, 5.2, 6.24]), ivRank: 18, ivPercentile: 23, ivIndex: 14.8, liquidity: 5, earningsDate: null, position: false, updatedAt: UPDATED_AT },
  ...
  { symbol: 'INTC', name: 'Intel', price: 31.72, change: -0.38, changePercent: -1.18, sparkline: spark(32.2, [0, -.08, .03, -.12, -.2, -.16, -.31, -.26, -.4, -.48]), ivRank: 21, ivPercentile: 28, ivIndex: 34.7, liquidity: 5, earningsDate: '2026-10-22', position: false, updatedAt: UPDATED_AT },
  ...
  { symbol: 'META', name: 'Meta Platforms', price: 782.17, change: 8.31, changePercent: 1.07, sparkline: spark(767, [0, 1.3, 3.2, 2.7, 6.1, 5.4, 8, 10.2, 12.6, 15.17]), ivRank: 35, ivPercentile: 44, ivIndex: 32.8, liquidity: 4, earningsDate: '2026-10-28', position: true, updatedAt: UPDATED_AT },
]
