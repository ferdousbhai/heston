...
export const marketTickersFixture: Ticker[] = [
  { symbol: 'SPY', name: 'SPDR S&P 500 ETF', price: 691.24, change: 3.82, changePercent: 0.56, sparkline: spark(685, [0, 1.2, 0.4, 2.5, 1.7, 3.8, 4.5, 3.9, 5.2, 6.24]), ivRank: 18, ivPercentile: 23, ivIndex: 14.8, liquidity: 5, earningsDate: null, position: true, updatedAt: UPDATED_AT },
  { symbol: 'NVDA', name: 'NVIDIA', price: 191.68, change: 4.91, changePercent: 2.63, sparkline: spark(181, [0, 2.4, 1.3, 3.1, 5.8, 4.4, 7.2, 8.1, 7.6, 10.68]), ivRank: 72, ivPercentile: 81, ivIndex: 48.2, liquidity: 5, earningsDate: '2026-08-26', position: true, updatedAt: UPDATED_AT },
  ...
  { symbol: 'AMD', name: 'Advanced Micro Devices', price: 176.22, change: 2.08, changePercent: 1.19, sparkline: spark(170, [0, 0.8, -0.4, 1.7, 2.4, 2, 3.8, 4.2, 5.1, 6.22]), ivRank: 57, ivPercentile: 64, ivIndex: 43.5, liquidity: 4, earningsDate: '2026-11-03', position: true, updatedAt: UPDATED_AT },
  ...
  { symbol: 'META', name: 'Meta Platforms', price: 782.17, change: 8.31, changePercent: 1.07, sparkline: spark(767, [0, 1.3, 3.2, 2.7, 6.1, 5.4, 8, 10.2, 12.6, 15.17]), ivRank: 35, ivPercentile: 44, ivIndex: 32.8, liquidity: 4, earningsDate: '2026-10-28', position: false, updatedAt: UPDATED_AT },
]
...
const research: ResearchBrief = {
  ...
  ideas: [
    { symbol: 'SPY', direction: 'bullish', setup: 'Defined-risk call spread', horizon: '45–75 DTE', thesis: 'Low index IV keeps upside convexity inexpensive.', risk: 'A volatility shock can steepen skew.' },
  ],
