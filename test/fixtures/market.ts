...
export const marketTickersFixture: Ticker[] = [
  { symbol: 'SPY', name: 'SPDR S&P 500 ETF', assetType: 'etf', lendability: 'Easy To Borrow', price: 691.24, yearLow: 481.8, yearHigh: 698.44, change: 3.82, changePercent: 0.56, sparkline: spark(685, [0, 1.2, 0.4, 2.5, 1.7, 3.8, 4.5, 3.9, 5.2, 6.24]), ivRank: 18, ivPercentile: 23, ivIndex: 14.8, ivIndex5DayChange: -0.7, historicalVolatility30Day: 12.9, ivHistoricalVolatility30DayDifference: 1.9, ivTermStructure: { frontExpiration: '2026-09-04', frontIv: 14.1, backExpiration: '2026-09-11', backIv: 14.8 }, liquidity: 5, earningsDate: null, updatedAt: UPDATED_AT },
  { symbol: 'NVDA', name: 'NVIDIA', assetType: 'stock', lendability: 'Easy To Borrow', marketCap: 4_730_000_000_000, volume: 128_400_000, price: 191.68, yearLow: 86.62, yearHigh: 195.95, change: 4.91, changePercent: 2.63, sparkline: spark(181, [0, 2.4, 1.3, 3.1, 5.8, 4.4, 7.2, 8.1, 7.6, 10.68]), ivRank: 72, ivPercentile: 81, ivIndex: 48.2, ivIndex5DayChange: 3.4, historicalVolatility30Day: 42.1, ivHistoricalVolatility30DayDifference: 6.1, ivTermStructure: { frontExpiration: '2026-09-04', frontIv: 55.4, backExpiration: '2026-09-11', backIv: 48.8 }, liquidity: 5, earningsDate: '2026-08-26', updatedAt: UPDATED_AT },
  { symbol: 'SPCX', name: 'SpaceX Corporation', price: 24.83, change: -0.11, changePercent: -0.44, sparkline: spark(24.7, [0, .04, .02, .08, .05, .1, .07, .11, .09, .13]), ivRank: 26, ivPercentile: 31, ivIndex: 22.6, liquidity: 2, earningsDate: null, updatedAt: UPDATED_AT },
  { symbol: 'BE', name: 'Bloom Energy', price: 43.16, change: 1.27, changePercent: 3.03, sparkline: spark(41.2, [0, .25, .1, .6, .4, .9, 1.2, 1.05, 1.6, 1.96]), ivRank: 68, ivPercentile: 77, ivIndex: 63.4, liquidity: 3, earningsDate: '2026-11-05', updatedAt: UPDATED_AT },
  { symbol: 'INTC', name: 'Intel', assetType: 'stock', lendability: 'Easy To Borrow', price: 31.72, yearLow: 17.67, yearHigh: 32.85, change: -0.38, changePercent: -1.18, sparkline: spark(32.2, [0, -.08, .03, -.12, -.2, -.16, -.31, -.26, -.4, -.48]), ivRank: 21, ivPercentile: 28, ivIndex: 34.7, ivIndex5DayChange: -2.1, historicalVolatility30Day: 37.4, ivHistoricalVolatility30DayDifference: -2.7, ivTermStructure: { frontExpiration: '2026-09-04', frontIv: 33.1, backExpiration: '2026-09-11', backIv: 35.7 }, liquidity: 5, earningsDate: '2026-10-22', updatedAt: UPDATED_AT },
  { symbol: 'AAPL', name: 'Apple', price: 236.41, change: -1.84, changePercent: -0.77, sparkline: spark(241, [0, -0.5, 0.3, -1.4, -2.1, -1.5, -3, -2.4, -3.7, -4.59]), ivRank: 46, ivPercentile: 52, ivIndex: 27.4, liquidity: 5, earningsDate: '2026-10-29', updatedAt: UPDATED_AT },
  { symbol: 'TSLA', name: 'Tesla', price: 338.12, change: -9.77, changePercent: -2.81, sparkline: spark(354, [0, -2.2, -1.1, -4.8, -6.4, -5.7, -9.2, -11.4, -12.2, -15.88]), ivRank: 84, ivPercentile: 89, ivIndex: 61.6, liquidity: 5, earningsDate: '2026-10-21', updatedAt: UPDATED_AT },
  { symbol: 'QQQ', name: 'Invesco QQQ', price: 618.73, change: 5.02, changePercent: 0.82, sparkline: spark(609, [0, 1.4, 0.8, 3.2, 4.7, 4.1, 6.5, 7.2, 8.4, 9.73]), ivRank: 24, ivPercentile: 31, ivIndex: 18.6, liquidity: 5, earningsDate: null, updatedAt: UPDATED_AT },
  { symbol: 'AMD', name: 'Advanced Micro Devices', price: 176.22, change: 2.08, changePercent: 1.19, sparkline: spark(170, [0, 0.8, -0.4, 1.7, 2.4, 2, 3.8, 4.2, 5.1, 6.22]), ivRank: 57, ivPercentile: 64, ivIndex: 43.5, liquidity: 4, earningsDate: '2026-11-03', updatedAt: UPDATED_AT },
  { symbol: 'IWM', name: 'iShares Russell 2000 ETF', price: 243.86, change: 1.37, changePercent: 0.57, sparkline: spark(239, [0, 0.3, -0.2, 1.1, 0.9, 2.4, 2.1, 3.2, 4, 4.86]), ivRank: 66, ivPercentile: 72, ivIndex: 25.9, liquidity: 5, earningsDate: null, updatedAt: UPDATED_AT },
